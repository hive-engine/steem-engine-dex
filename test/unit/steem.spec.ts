...
describe('Steem', () => {
    ...
    it('steemConnectJson calls popupCenter with formatted arguments, active key and url', () => {
        ...
        const url = 'https://steemconnect.com/sign/custom-json?required_posting_auths=%5B%5D&required_auths=%5B%22beggars%22%5D&id=ssc-mainnet1&json=%7B%22value%22:%22aggroed%22%7D';
